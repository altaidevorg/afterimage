...
*   **`AsyncConversationGenerator`**: The primary engine for multi-turn chat.
*   **`AsyncStructuredGenerator`**: Specialized engine for single-turn data extraction into JSON.
