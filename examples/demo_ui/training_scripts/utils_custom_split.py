...
def prepare_dataset_with_tool_call_test(dataset_file: str, tokenizer, tools_schema, test_size = 0.10, seed: int = 42):
    """
    ...
    print(f"[INFO] Allocating {actual_test_size} tool call samples for testing ({test_size*100 if isinstance(test_size, float) else actual_test_size}%)...")
