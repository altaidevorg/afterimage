...
class GeneratedResponsePrompt(BaseModel):
    ...
    metadata: dict[str, Any] = Field(
        default_factory=dict, description="Additional metadata about respondent promp generation"
    )


class Document(BaseModel):
    id: str = Field(default_factory=lambda: str(uuid.uuid4()), description="Id of the document. Autogenerated if not specified")
    text: Optional[str] = None
    personas: list[PersonaEntry] = Field(default_factory=list, description="List of persona generations")
